...
public class pnLogin extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fbpnObj=new Firebase("https://foodconnect-ce150.firebaseio.com/");
        ...
        auth.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else
                {
                    ...
                    fbpnObj.addValueEventListener(new ValueEventListener() {
                        @Override
                            ...
                            for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                                ...
                                if (person.getUname().toString().equals(unameS.toString())) {
                                    ...
                                    if (person.getPass().equals(passS)) {
                                        ...
                                        Intent intent=new Intent(pnLogin.this,listAll.class);
